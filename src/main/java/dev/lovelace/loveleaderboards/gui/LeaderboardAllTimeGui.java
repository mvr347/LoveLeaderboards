...
public class LeaderboardAllTimeGui extends BaseGui {
    ...
    public LeaderboardAllTimeGui(LoveLeaderboards plugin, Player viewer, String currentCategory, String entityType) {
        ...
        LeaderboardMainGui mainGui = new LeaderboardMainGui(plugin, viewer, currentCategory, TimePeriod.ALL_TIME, 1);
        this.inventory = mainGui.getInventory();
    }

    @Override
    public void open(Player player) {
        player.openInventory(new LeaderboardMainGui(plugin, viewer, currentCategory, TimePeriod.ALL_TIME, 1).getInventory());
    }
